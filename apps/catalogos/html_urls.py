...
urlpatterns = [
    ...
    path("catalogos/marcas/<int:pk>/eliminar/", html_views.marcas_delete, name="catalogos-marcas-delete"),
    ...
    path("catalogos/modelos/<int:pk>/eliminar/", html_views.modelos_delete, name="catalogos-modelos-delete"),
    ...
    path("catalogos/categorias/<int:pk>/eliminar/", html_views.categorias_delete, name="catalogos-categorias-delete"),
    ...
    path("catalogos/nombres-piezas/<int:pk>/eliminar/", html_views.nombres_piezas_delete, name="catalogos-nombres-piezas-delete"),
    ...
    path("catalogos/alias-piezas/<int:pk>/eliminar/", html_views.alias_piezas_delete, name="catalogos-alias-piezas-delete"),
]
